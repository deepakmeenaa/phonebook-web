...
//when submit-search is done.

if(isset($_POST['submit-search']))
{
     $search = mysqli_real_escape_string($conn,$_POST['search']);
     $sql = "SELECT * FROM address WHERE name LIKE '%$search%'"; //query for selecting all columns from table where the searched name is  a part of name column.

     $result =  mysqli_query($conn , $sql);
     $queryResult = mysqli_num_rows($result); //counting the number of results matching the searched name.
     ...
     if ($queryResult > 0) //searched contact is displayed
     {
     ...
     else //if the contact searched is nt in database.
        {
